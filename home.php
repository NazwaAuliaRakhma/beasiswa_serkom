...
<div class="scholarship-section">
    <ul>
        ...
        <li>
            ...
            <p>Prestasi di bidang olahraga, seni, atau kegiatan sosial.</p>
        </li>
        <li>
            <strong>Beasiswa C</strong>: Beasiswa untuk anak karyawan Telkom.
            <p>Berprestasi dan membutuhkan bantuan biaya kuliah.</p>
        </li>
    </ul>
</div>

<a href="index.php?page=pilihan_beasiswa" class="btn btn-custom">Jelajahi Beasiswa</a>